...
if ($_SERVER['REQUEST_METHOD']=='POST') {
    if ($_GET['act']=="insert") {
        ...
        $query = "INSERT INTO pengguna (username, password, nama_lengkap, email, jabatan, hak_akses) VALUES ('$username', '$password', '$nama_lengkap', '$email', '$jabatan', '$hak_akses')";
        ...
        $hak_akses = $_POST['hak_akses'];
        if (empty($password)) {
            $query = "UPDATE pengguna SET username = '$username', nama_lengkap = '$nama_lengkap', email = '$email', jabatan = '$jabatan', hak_akses = '$hak_akses' WHERE username = '$username'";
            $exec = mysqli_query($koneksi, $query);
            if ($exec) {
            ...
            $query = "UPDATE pengguna SET username = '$username', password = '$password', nama_lengkap = '$nama_lengkap', email = '$email', jabatan = '$jabatan', hak_akses = '$hak_akses' WHERE username = '$username'";
            $exec = mysqli_query($koneksi, $query);
            if ($exec) {
